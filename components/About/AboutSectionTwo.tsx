      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            <div
              className="wow fadeInUp hover:shadow-two dark:hover:shadow-gray-dark group relative overflow-hidden rounded-sm bg-white shadow-one duration-300 dark:bg-dark mx-auto mb-12 block aspect-[37/22] max-w-[500px] text-center lg:m-2"
              data-wow-delay=".15s"
            >
              <Image
                src="/images/blog/rsbprojector.jpg"
                alt="about image"
                fill
            ...
            >
              <Image
                src="/images/blog/sparecollage.jpg"
                alt="about image"
                fill
                className="drop-shadow-three dark:hidden dark:drop-shadow-none"
              />
